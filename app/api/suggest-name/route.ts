...
const SCHEMA = {
  ...
  properties: {
    ...
    curationTips: {
      type: 'array',
      items: { type: 'string' },
      description: '셀러가 참고할 스타일링/트렌드/타겟 관련 큐레이션 팁 (개수 제한 없음)'
    }
  },
          ...
          content: [
            ...
            },
            {
              ...
              text:
                ...
                '사진에서 보이면 반영하세요.\n\n' +
                '그리고 셀러가 판매할 때 참고할 수 있는 큐레이션 팁도 자유롭게 제안해주세요 — 스타일링 제안(예: 하객룩, ' +
                '데일리룩), 요즘 유행하는 디자인 요소와의 연관성, 어울리는 타겟 고객층 등을 개수 제한 없이 창의적으로 ' +
                '작성해주세요.'
            }
          ]
        }
